...
- Названия материалов — словарём прайса: «ткань 600D», «ткань 200D», «стропа 25мм», «стропа 40мм», «фастексы 25 мм», «полукольца 40 мм», «молния T7», «замки T7», «пряжка 2х щелевая 25 мм», «нитки». Если позиции нет в словаре — оставь как есть, калькулятор отнесёт её в «Не учтено».
