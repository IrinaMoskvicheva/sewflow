...
Предприниматель — владелец микро-производства, который сам ведёт продукт,
производство и продажи на маркетплейсах (Ozon, Wildberries). Подойдёт любому
...
2. **Калькулятор себестоимости** — на вход: техкарта из `tech_maps/` +
   ...
   каждого материала, полная себестоимость изделия.
...
|---|---|---|
| ![main](screenshots/01-dashboard.png) | ![cost](screenshots/02-cost-dashboard.png) | ![drawing](tech_maps/сноуборд%20145.png) |
